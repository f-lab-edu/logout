...
import com.example.hotelproject.room.repository.RoomQuantityRepository;
...
public class RoomService {
    ...
    public RoomService(HotelRepository hotelRepository, RoomRepository roomRepository,
            RoomQuantityRepository roomQuantityRepository) {
        this.hotelRepository = hotelRepository;
        this.roomRepository = roomRepository;
        this.roomQuantityRepository = roomQuantityRepository;
    }

...
//    }
    ...
    @GetMapping("/search")
    public List<HotelResponse> searchHotels(@RequestBody HotelSearchRequest hotelSearchRequest,
            Long cursor, int limit) {
        return hotelService.searchHotels(cursor, limit, hotelSearchRequest);
    }
}
